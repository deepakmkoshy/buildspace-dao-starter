...
(
    async() =>{
       try{const editionDropAddress = await sdk.deployer.deployEditionDrop({
            name: "AtherDAO membership",
        //Description for the collection
            description: "A DAO for ather owners",
// The image that will be held on our NFT! The fun part :).
image: readFileSync("scripts/assets/ather.jpg"),
